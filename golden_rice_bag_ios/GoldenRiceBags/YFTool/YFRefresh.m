...
@implementation YFRefresh

- (instancetype)init {
    if (self = [super init]) {

        //闲置状态下的gif(就是拖动的时候变化的gif)
        idleImages = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"Image"], [UIImage imageNamed:@"Image1"], [UIImage imageNamed:@"Image2"],[UIImage imageNamed:@"Image3"], [UIImage imageNamed:@"Image4"], [UIImage imageNamed:@"Image5"], nil];
        //已经到达偏移量的gif(就是已经到达偏移量的时候的gif)
        pullingImages = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"Image"], [UIImage imageNamed:@"Image1"], [UIImage imageNamed:@"Image2"],[UIImage imageNamed:@"Image3"], [UIImage imageNamed:@"Image4"], [UIImage imageNamed:@"Image5"], nil];
        //正在刷新的时候的gif
        refreshingImages = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"Image"], [UIImage imageNamed:@"Image1"], [UIImage imageNamed:@"Image2"],[UIImage imageNamed:@"Image3"], [UIImage imageNamed:@"Image4"], [UIImage imageNamed:@"Image5"], nil];
    }
    return self;
}
