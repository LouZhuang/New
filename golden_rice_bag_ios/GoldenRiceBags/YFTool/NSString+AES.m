...
static NSString *const PSW_AES_KEY = @"y2W89L6BkRAFljhN";
static NSString *const AES_IV_PARAMETER = @"dMitHORyqbeYVE0o";
...
- (NSString*)aci_encryptWithAES {
    ...
    // 不足4倍长度，补'='
    NSMutableString * base64Str = [[NSMutableString alloc]initWithString:baseStr_GTM];
