...
- (void)setupImageView:(NSMutableArray *)array{
    ...
    for (int i = 0; i < array.count ; i++) {
        ...
        photoZoomView.imageNormalHeight = WIDTH;
    ...
    [self.scrollView setContentOffset:CGPointMake(self.indexRow *WIDTH, 0) animated:NO];
...
//    self.indexLabel.text = [NSString stringWithFormat:@"%d/%d", self.index + 1,self.count];
    ...
    [self.inDelegate tittle:[NSString stringWithFormat:@"%ld",self.index + 1]];
