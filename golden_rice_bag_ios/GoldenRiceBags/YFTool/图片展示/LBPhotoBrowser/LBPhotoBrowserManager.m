...
- (void)showImageWithURLArray:(NSArray *)urls fromImageViews:(NSArray *)imageViews andSelectedIndex:(int)index andImageViewSuperView:(UIView *)superView {
    ...
    LBPhotoBrowserView *photoBrowseView = [[LBPhotoBrowserView alloc]initWithFrame:CGRectMake(0, 0, superView.frame.size.width, superView.frame.size.height)];
    ...
    [superView addSubview:photoBrowseView];
