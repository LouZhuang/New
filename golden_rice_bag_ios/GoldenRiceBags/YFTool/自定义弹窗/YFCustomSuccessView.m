...
@implementation YFCustomSuccessView
...
-(void)configuration
{
    ...
    [self.popView sd_addSubviews:@[self.imageView,self.tittleLabel,self.contentLabel,self.determineButton]];
    ...
    .topSpaceToView(self.popView, YF_H(80))
    .leftSpaceToView(self.popView, YF_W(14))
    .widthIs(WIDTH - YF_W(88))
    .heightIs(YF_H(24));
    
    self.contentLabel.sd_layout
    .topSpaceToView(self.popView, YF_H(114))
    .leftSpaceToView(self.popView, YF_W(14))
    .widthIs(WIDTH - YF_W(88))
    .heightIs(YF_H(20));
...
-(UIImageView *)imageView
{
    if (!_imageView) {
        ...
        imageView.image = [UIImage imageNamed:@"successImage"];
