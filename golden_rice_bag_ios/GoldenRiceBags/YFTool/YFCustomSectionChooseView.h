...
#import "YFTool.h"
@protocol YFCustomSectionVCDelegate <NSObject>
@required
- (void)YFCustomSectionSelectIndex:(NSInteger)selectIndex;

@end
@interface YFCustomSectionChooseView : UIView
/**
 *  圆角 默认 4
 */
...
@property (nonatomic, assign) id <YFCustomSectionVCDelegate>delegate;
