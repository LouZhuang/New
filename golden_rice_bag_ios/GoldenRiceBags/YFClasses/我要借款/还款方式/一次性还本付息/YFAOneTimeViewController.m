...
@interface YFAOneTimeViewController ()<UITableViewDelegate,UITableViewDataSource>
/*
 tableview
 */
...
@implementation YFAOneTimeViewController
...
-(void)DataRequest
{
    ...
    [YFBorrowingRequest YFPageSizeString:self.sizeString principalString:self.principalString repayTypeString:@"3" success:^(id json) {
