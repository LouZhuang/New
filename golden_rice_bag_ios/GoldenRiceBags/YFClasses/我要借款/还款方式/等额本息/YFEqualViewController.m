...
@interface YFEqualViewController ()<UITableViewDelegate,UITableViewDataSource>
/*
 tableview
 */
...
@implementation YFEqualViewController
...
-(void)DataRequest
{
    ...
    [YFBorrowingRequest YFPageSizeString:self.sizeString principalString:self.principalString repayTypeString:@"1" success:^(id json) {
