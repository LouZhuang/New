//
//  YFFinancialDetailsListTableViewCell.m
//  GoldenRiceBags
//
...
@interface YFFinancialDetailsListTableViewCell ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource,UIScrollViewDelegate>
...
@end
@implementation YFFinancialDetailsListTableViewCell
- (void)dealloc {
    //清除监听
...
- (void)customPageView:(id)data
{
    ...
    self.dataArray = @[ctrl2].mutableCopy;
...
+ (void)regisCellForTableView:(UITableView *)tableView {
    [tableView registerClass:[YFFinancialDetailsListTableViewCell class] forCellReuseIdentifier:@"cellid"];
}
