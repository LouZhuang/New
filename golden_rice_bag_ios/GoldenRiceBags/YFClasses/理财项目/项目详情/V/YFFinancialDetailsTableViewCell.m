//
//  YFFinancialDetailsTableViewCell.m
//  GoldenRiceBags
//
...
@interface YFFinancialDetailsTableViewCell ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource,UIScrollViewDelegate>
...
@implementation YFFinancialDetailsTableViewCell
- (void)dealloc {
    //清除监听
...
- (void)customPageView:(id)data
{
    ...
    YFProjectTableViewController *ctrl1 = [[YFProjectTableViewController alloc] init];
    ctrl1.projectDetailId=data;
    YFInvestmentTableViewController *ctrl2 = [[YFInvestmentTableViewController alloc] init];
    ctrl2.projectDetailId=data;
    YFCertificationTableViewController *ctrl3 = [[YFCertificationTableViewController alloc] init];
    ctrl3.projectDetailId=data;
...
+ (void)regisCellForTableView:(UITableView *)tableView {
    [tableView registerClass:[YFFinancialDetailsTableViewCell class] forCellReuseIdentifier:@"cellid"];
}
