//
//  YFCreditorsRightsTransferViewController.m
//  GoldenRiceBags
//
...
@interface YFCreditorsRightsTransferViewController ()<UIScrollViewDelegate,SectionChooseVCDelegate>
...
@implementation YFCreditorsRightsTransferViewController
...
- (void)setupUIScrollView {
    ...
    _YF_scrollerView.contentSize = CGSizeMake(self.view.frame.size.width * 4, 0);
    ...
    self.sectionChooseView = [[SectionChooseView alloc] initWithFrame:CGRectMake(0, YF_H(10), WIDTH, YF_H(50)) titleArray:@[@"可转让", @"转让中", @"已转让", @"已转入"]];
...
-(void)setupChildViewController {
    ...
    /*
     可转让
     */
    YFCreditorsRightsTransferCanViewController *aVC = [[YFCreditorsRightsTransferCanViewController alloc] init];
    ...
    转让中
     */
    YFCreditorsRightsTransferInTheViewController *bVC = [[YFCreditorsRightsTransferInTheViewController alloc] init];
    ...
    /*
     已转让
     */
    YFCreditorsRightsTransferHasViewController *cVC = [[YFCreditorsRightsTransferHasViewController alloc] init];
    ...
    /*
     已转入
     */
    YFCreditorsRightsTransferInToTheViewController *dVC = [[YFCreditorsRightsTransferInToTheViewController alloc] init];
