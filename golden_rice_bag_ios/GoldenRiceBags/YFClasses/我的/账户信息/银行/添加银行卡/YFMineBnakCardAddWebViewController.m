//
//  YFMineBnakCardAddWebViewController.m
//  GoldenRiceBags
//
...
#import "YFMineBnakCardAddWebViewController.h"
#import <WebKit/WebKit.h>
#import "YFAccountInformationViewController.h"
@interface YFMineBnakCardAddWebViewController ()<WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>
@property(nonatomic,strong)WKWebView *YFWKWebView;
@property (nonatomic, strong) UIProgressView *progressView;//设置加载进度条

@end

@implementation YFMineBnakCardAddWebViewController
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler
{
    ...
    if ([requestString rangeOfString:subStr].location != NSNotFound) {
        ...
        if ([self.title isEqualToString:@"我要投资"]) {
