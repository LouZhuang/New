//
//  YFMineBnakCardViewController.m
//  GoldenRiceBags
//
...
#import "YFMineBnakCardViewController.h"

@interface YFMineBnakCardViewController ()<UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate,YFCustomOpenTheDepositoryDelegate,YFOpenAnAccountDelegate>
...
@implementation YFMineBnakCardViewController
{
    NSInteger total;
}
...
-(void)UnBindCard
{
    [YFMineRequest YFSwitchPrePhoneTypeString:@"0" success:^(id json) {
...
-(UILabel *)footerLabel
{
    if (!_footerLabel) {
        ...
        label.text=@"温馨提示：\n为增强账户安全，每个用户仅能绑定一张银行卡；\n有提现处理中交易时不允许删除银行卡；\n 如有疑问，请联系客服：400-123-456(工作日9:00-18:00)";
        _footerLabel = label;
    }
    return _footerLabel;
}
...
-(void)DataRequest
{
    [YFMineRequest YFBankCardTypeString:@"0" success:^(id json) {
