//
//  YFChangeThePaymentPasswordViewController.m
//  GoldenRiceBags
//
...
#import "YFChangeThePaymentPasswordViewController.h"

@interface YFChangeThePaymentPasswordViewController ()<SectionChooseVCDelegate,UIScrollViewDelegate>
/*
 选择器
 */
...
@implementation YFChangeThePaymentPasswordViewController
...
-(void)setupChildViewController {
    ...
    /*
     投资账户
     */
    YFChangeThePaymentPasswordOneViewController *aVC = [[YFChangeThePaymentPasswordOneViewController alloc] init];
    ...
    /*
     借款账户
     */
    YFChangeThePaymentPasswordTwoViewController *bVC = [[YFChangeThePaymentPasswordTwoViewController alloc] init];
