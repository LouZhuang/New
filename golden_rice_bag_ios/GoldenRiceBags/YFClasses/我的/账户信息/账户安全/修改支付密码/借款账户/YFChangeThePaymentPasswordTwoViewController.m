//
//  YFChangeThePaymentPasswordTwoViewController.m
//  GoldenRiceBags
//
...
#import "YFChangeThePaymentPasswordTwoViewController.h"

@interface YFChangeThePaymentPasswordTwoViewController ()<UITableViewDelegate,UITableViewDataSource>
/*
 tableview
 */
...
@implementation YFChangeThePaymentPasswordTwoViewController
...
-(void)statusString:(NSString *)status
{
    ...
    [YFMineRequest YFModifyTradePasswordTypeString:@"0" statusString:status success:^(id json) {
