//
//  YFModifyPhoneNumberViewController.m
//  GoldenRiceBags
//
...
#import "YFModifyPhoneNumberViewController.h"

@interface YFModifyPhoneNumberViewController ()

@end

@implementation YFModifyPhoneNumberViewController
    ...
    GTVerifyCodeView *codeView = [[GTVerifyCodeView alloc] initWithFrame:CGRectMake(0, YF_H(209),WIDTH, YF_H(60)) onFinishedEnterCode:^(NSString *code) {
        ...
        [YFLoginRequest YFPhoneString:_phoneString keyCodeString:@"common" smsCodeString:code success:^(id json) {
            if ([YFTool Nsdic:json]==1) {
                ...
                YFModifyPhoneNumberDetailViewController *YFReferenceCellPhoneNumberVC = [[YFModifyPhoneNumberDetailViewController alloc] init];
