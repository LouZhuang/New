//
//  TFMyRedPacketsFailureViewController.m
//  GoldenRiceBags
//
...
@interface TFMyRedPacketsFailureViewController ()<UIScrollViewDelegate,SectionChooseVCDelegate>
...
@implementation TFMyRedPacketsFailureViewController
...
-(void)setupChildViewController {
    ...
    /*
     加息券
     */
    YFRateCouponFailureViewController *aVC = [[YFRateCouponFailureViewController alloc] init];
    ...
    /*
     洪波啊
     */
    YFARedEnvelopeFailureViewController *bVC = [[YFARedEnvelopeFailureViewController alloc] init];
