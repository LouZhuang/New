//
//  YFARedEnvelopeFailureViewController.m
//  GoldenRiceBags
//
...
#import "YFARedEnvelopeFailureViewController.h"

@interface YFARedEnvelopeFailureViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation YFARedEnvelopeFailureViewController
static NSString *cellId = @"TFMyRedPacketsListFailureTableViewCell";
- (void)viewDidLoad {
    [super viewDidLoad];
      [self configuration];
    /*
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TFMyRedPacketsListFailureTableViewCell *cell = [tableView cellForRowAtIndexPath:indexPath];
    if (cell == nil) {
        cell = [[TFMyRedPacketsListFailureTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
...
-(void)DataRequest
{
    [YFMineRequest YFPageNumString:@"1" PageSizeString:@"10" TypeString:@"2" IdString:[YFTool userDefaultsId:YFID] StatusString:@"1" success:^(id json) {
